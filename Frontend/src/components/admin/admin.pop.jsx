    ...
    <Model isOpen={isOpen} onClose={onClose} title="Add New Destination">
      ...
      <div className="relative mb-4 px-4" ref={dropdownRef}>
        <div className="relative flex items-center">
          ...
          {isSearching && (
            <FaSpinner
              className="absolute right-3 text-gray-500 animate-spin z-10"
              size={13}
            />
          )}
          <input
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              value={formData.type}
              onChange={handleChange}
              className="w-full border-b bg-gray-800 border-gray-700 py-2"
              disabled={isUploading}
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full bg-gray-800 border-b border-gray-700 py-2"
              disabled={isUploading}
            >
        ...
        <input
          ...
          value={formData.tags}
          onChange={handleChange}
          placeholder="Tags (trekking, scenic...)"
          className={inputClass}
        />
        ...
        <div className="flex justify-end space-x-4 pt-8 pb-4 border-t border-gray-800">
          ...
          <button
            type="submit"
            disabled={isUploading}
            className="px-10 py-2 bg-blue-600 text-white rounded-full font-bold flex items-center gap-2"
          >
