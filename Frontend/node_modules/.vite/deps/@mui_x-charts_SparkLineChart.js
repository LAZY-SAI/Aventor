...
import {
  ...
  step_default,
  symbolsFill
} from "./chunk-7LZVUJ4K.js";
import "./chunk-FCSS27DJ.js";
import {
  _extends
} from "./chunk-EQCCHGRT.js";
import "./chunk-VKFFB3L6.js";
import "./chunk-ZZZM3NDM.js";
import {
  require_jsx_runtime
} from "./chunk-BESRWBHT.js";
import {
  require_react
} from "./chunk-M26Z6HXZ.js";
import {
  __toESM
...
var _excluded = ["seriesId", "dataIndex", "color", "isFaded", "isHighlighted", "classes", "skipAnimation", "layout", "xOrigin", "yOrigin", "placement", "hidden"];
...
function BarLabel(inProps) {
  ...
  return (0, import_jsx_runtime2.jsx)(BarLabelComponent, _extends({
    textAnchor,
    dominantBaseline,
...
var _excluded2 = ["seriesId", "classes", "color", "dataIndex", "barLabel", "slots", "slotProps", "xOrigin", "yOrigin", "x", "y", "width", "height", "value", "skipAnimation", "layout", "barLabelPlacement", "hidden"];
...
function BarLabelItem(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(Component, _extends({}, barLabelProps, barLabelOwnerState, {
    hidden,
...
var _excluded3 = ["processedSeries", "className", "skipAnimation"];
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime4.jsx)("g", {
    className,
    ...
    children: data.map(({
      ...
      height,
      hidden
    }) => (0, import_jsx_runtime4.jsx)(BarLabelItem, _extends({
      seriesId,
      dataIndex,
      value,
      color,
...
// node_modules/@mui/x-charts/esm/BarChart/IndividualBarPlot.js
...
var _excluded4 = ["ownerState", "skipAnimation", "id", "dataIndex", "xOrigin", "yOrigin"];
function AnimatedBarElement(props) {
  const {
    ownerState
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded4);
  const animatedProps = useAnimateBar(props);
  return (0, import_jsx_runtime5.jsx)("rect", _extends({}, other, {
...
var _excluded5 = ["id", "dataIndex", "classes", "color", "slots", "slotProps", "style", "onClick", "skipAnimation", "layout", "x", "xOrigin", "y", "yOrigin", "width", "height", "hidden"];
function BarElement(props) {
  ...
  const itemIdentifier = React5.useMemo(() => ({
    type: "bar",
    seriesId: id,
    dataIndex
  }), [id, dataIndex]);
  ...
  const isFocused = useIsItemFocused(React5.useMemo(() => ({
    type: "bar",
    seriesId: id,
    dataIndex
  }), [id, dataIndex]));
...
var _excluded6 = ["completedData", "masksData", "borderRadius", "onItemClick", "skipAnimation"];
...
// node_modules/@mui/x-charts/esm/BarChart/BatchBarPlot/BatchBarPlot.js
var React11 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/esm/BarChart/useRegisterItemClickHandlers.js
var React8 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/esm/internals/invertScale.js
...
// node_modules/@mui/x-charts/esm/internals/plugins/featurePlugins/useChartCartesianAxis/useChartCartesianAxisPosition.selectors.js
var selectorBarItemAtPosition = createSelector(selectorChartXAxis, selectorChartYAxis, selectorChartSeriesProcessed, function selectorBarItemAtPosition2({
  axis: xAxes,
  axisIds: xAxisIds
}, {
  axis: yAxes,
...
// node_modules/@mui/x-charts/esm/internals/appendAtKey.js
...
// node_modules/@mui/x-charts/esm/BarChart/BatchBarPlot/useCreateBarPaths.js
...
// node_modules/@mui/x-charts/esm/BarChart/BatchBarPlot/BarGroup.js
var React9 = __toESM(require_react(), 1);
var import_jsx_runtime9 = __toESM(require_jsx_runtime(), 1);
var _excluded7 = ["skipAnimation", "layout", "xOrigin", "yOrigin"];
...
function BarGroup(_ref) {
  ...
  if (skipAnimation) {
    return (0, import_jsx_runtime9.jsx)(PathGroup, _extends({}, props));
  }
  return (0, import_jsx_runtime9.jsx)(AnimatedGroup, _extends({}, props, {
    layout,
    xOrigin,
    yOrigin
  }));
...
function AnimatedGroup(_ref2) {
  ...
  if (layout === "horizontal") {
    animateChildren.push((0, import_jsx_runtime9.jsx)(AnimatedRect, {
      "data-orientation": "horizontal",
      x: drawingArea.left,
  ...
  return (0, import_jsx_runtime9.jsxs)(React9.Fragment, {
    ...
    }), (0, import_jsx_runtime9.jsx)(PathGroup, _extends({
...
// node_modules/@mui/x-charts/esm/internals/plugins/featurePlugins/shared/useRegisterPointerInteractions.js
...
function useRegisterPointerInteractions(getItemAtPosition, onItemEnter, onItemLeave) {
  ...
  const svgRef = useSvgRef();
  const store = useStore();
  const interactionActive = React10.useRef(false);
  const lastItemRef = React10.useRef(void 0);
  const onItemEnterRef = useEventCallback_default(() => onItemEnter?.());
  const onItemLeaveRef = useEventCallback_default(() => onItemLeave?.());
  React10.useEffect(() => {
...
function BatchBarPlot({
  ...
  const prevCursorRef = React11.useRef(null);
  const svgRef = useSvgRef();
  ...
  return (0, import_jsx_runtime10.jsx)(React11.Fragment, {
    children: completedData.map((series) => (0, import_jsx_runtime10.jsx)(SeriesBatchPlot, {
      series,
      borderRadius,
      skipAnimation
    }, series.seriesId))
...
var MemoFadedHighlightedBars = React11.memo(FadedHighlightedBars);
...
function SeriesBatchPlot({
  ...
  return (0, import_jsx_runtime10.jsxs)(React11.Fragment, {
    children: [(0, import_jsx_runtime10.jsx)(BarGroup, {
      className: classes.series,
      ...
      children: (0, import_jsx_runtime10.jsx)(BatchBarSeriesPlot, {
        processedSeries: series,
        borderRadius
      })
    }), (0, import_jsx_runtime10.jsx)(MemoFadedHighlightedBars, {
      processedSeries: series,
      borderRadius
    })]
  });
...
function BatchBarSeriesPlot({
  ...
  for (const [fill, dArray] of paths.entries()) {
    for (const d of dArray) {
      children.push((0, import_jsx_runtime10.jsx)("path", {
        fill,
        d
      }, i));
      i += 1;
...
function FadedHighlightedBars({
  ...
  if (seriesHighlightedItem != null) {
    siblings.push((0, import_jsx_runtime10.jsx)("path", {
...
var _excluded8 = ["skipAnimation", "onItemClick", "borderRadius", "barLabel", "renderer"];
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime11.jsxs)(BarPlotRoot, {
    className: classes.root,
    children: [(0, import_jsx_runtime11.jsx)(BarElementPlot, _extends({
      completedData,
      masksData,
      ...
      borderRadius
    }, other)), completedData.map((processedSeries) => (0, import_jsx_runtime11.jsx)(BarLabelPlot, _extends({
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React13.useState(false);
  React13.useEffect(() => {
    setIsHydrated(true);
  }, []);
  return isHydrated;
...
function useTicks(options) {
  ...
  return React14.useMemo(() => getTicks({
    scale,
    tickNumber,
    tickPlacement,
    tickInterval,
...
function ChartsText(props) {
  ...
  return (0, import_jsx_runtime12.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index) => (0, import_jsx_runtime12.jsx)("tspan", {
      x,
  ...
  return (0, import_jsx_runtime13.jsx)(React17.Fragment, {
    children: xTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime13.jsxs)("g", {
        ...
        children: [!disableTicks && showTick && (0, import_jsx_runtime13.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps?.axisTick)), tickLabel !== void 0 && showTickLabel && (0, import_jsx_runtime13.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
          text: tickLabel
...
function ChartsXAxisImpl(_ref) {
  ...
  if (!skipTickRendering) {
    children = "groups" in axis && Array.isArray(axis.groups) ? (0, import_jsx_runtime15.jsx)(ChartsGroupedXAxisTicks, _extends({}, inProps)) : (0, import_jsx_runtime15.jsx)(ChartsSingleXAxisTicks, _extends({}, inProps, {
  ...
  return (0, import_jsx_runtime15.jsxs)(XAxisRoot, {
    ...
    }, slotProps?.axisLine)), children, label && (0, import_jsx_runtime15.jsx)("g", {
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime16.jsx)(ChartsXAxisImpl, _extends({}, inProps, {
    axis
  }));
}
    ...
    children: yTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime17.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime17.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps?.axisTick)), tickLabel !== void 0 && !skipLabel && (0, import_jsx_runtime17.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: tickLabel
        }, axisTickLabelProps))]
...
function ChartsGroupedYAxisTicks(inProps) {
  ...
  return (0, import_jsx_runtime18.jsx)(React22.Fragment, {
    children: yTicks.map((item, index) => {
      const {
        offset: tickOffset,
        labelOffset
      ...
      return (0, import_jsx_runtime18.jsxs)("g", {
        ...
        className: classes.tickContainer,
        "data-group-index": groupIndex,
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime18.jsx)(Tick, _extends({
          x2: tickXSize,
          className: classes.tick
        }, slotProps?.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime18.jsx)(TickLabel, _extends({
          x: labelPositionX,
          y: yTickLabel
        }, axisTickLabelProps, {
          style: _extends({}, axisTickLabelProps.style, groupConfig.tickLabelStyle),
...
function ChartsYAxisImpl(_ref) {
  ...
  let children = null;
  if (!skipTickRendering) {
    children = "groups" in axis && Array.isArray(axis.groups) ? (0, import_jsx_runtime19.jsx)(ChartsGroupedYAxisTicks, _extends({}, inProps)) : (0, import_jsx_runtime19.jsx)(ChartsSingleYAxisTicks, _extends({}, inProps, {
      axisLabelHeight,
      ordinalTimeTicks
    }));
  }
  return (0, import_jsx_runtime19.jsxs)(YAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime19.jsx)(Line, _extends({
      ...
      y2: top + height,
      className: classes.line
    }, lineProps)), children, label && isHydrated && (0, import_jsx_runtime19.jsx)("g", {
      className: classes.label,
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime20.jsx)(ChartsYAxisImpl, _extends({}, inProps, {
    axis
  }));
}
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime21.jsxs)(React24.Fragment, {
    children: [xAxisIds.map((axisId) => {
      ...
      return (0, import_jsx_runtime21.jsx)(ChartsXAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
      ...
      return (0, import_jsx_runtime21.jsx)(ChartsYAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
...
function ChartsYHighlight(props) {
  ...
  return axisYValues.map(({
    ...
    return (0, import_jsx_runtime22.jsxs)(React25.Fragment, {
      children: [isYScaleOrdinal && yScale(value) !== void 0 && (0, import_jsx_runtime22.jsx)(ChartsAxisHighlightPath, {
        d: `M ${left} ${yScale(value) - (yScale.step() - yScale.bandwidth()) / 2} l 0 ${yScale.step()} l ${width} 0 l 0 ${-yScale.step()} Z`,
        className: classes.root,
        ownerState: {
          axisHighlight: "band"
        }
      }), type === "line" && value !== null && (0, import_jsx_runtime22.jsx)(ChartsAxisHighlightPath, {
...
function ChartsXHighlight(props) {
  ...
  return axisXValues.map(({
    ...
    return (0, import_jsx_runtime23.jsxs)(React26.Fragment, {
      children: [isXScaleOrdinal && xScale(value) !== void 0 && (0, import_jsx_runtime23.jsx)(ChartsAxisHighlightPath, {
        d: `M ${xScale(value) - (xScale.step() - xScale.bandwidth()) / 2} ${top} l ${xScale.step()} 0 l 0 ${height} l ${-xScale.step()} 0 Z`,
        className: classes.root,
        ownerState: {
          axisHighlight: "band"
        }
      }), type === "line" && value !== null && (0, import_jsx_runtime23.jsx)(ChartsAxisHighlightPath, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime24.jsxs)(React27.Fragment, {
    children: [xAxisHighlight && xAxisHighlight !== "none" && (0, import_jsx_runtime24.jsx)(ChartsXHighlight, {
      type: xAxisHighlight,
      classes
    }), yAxisHighlight && yAxisHighlight !== "none" && (0, import_jsx_runtime24.jsx)(ChartsYHighlight, {
      type: yAxisHighlight,
      classes
    })]
  });
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime25.jsx)(React28.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => !instance.isXInside(offset) ? null : (0, import_jsx_runtime25.jsx)(GridLine, {
      y1: start,
      y2: end,
      x1: offset,
      x2: offset,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(React29.Fragment, {
    children: yTicks.map(({
      value,
      offset
    }) => !instance.isYInside(offset) ? null : (0, import_jsx_runtime26.jsx)(GridLine, {
      y1: offset,
      y2: offset,
      x1: start,
      x2: end,
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime27.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime27.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      start: drawingArea.top,
      end: drawingArea.height + drawingArea.top,
      classes
    }), horizontal && (0, import_jsx_runtime27.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
...
// node_modules/@mui/x-charts/esm/BarChart/useBarChartProps.js
var _excluded15 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "axisHighlight", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className", "hideLegend", "showToolbar", "brushConfig", "renderer"];
var useBarChartProps = (props) => {
  ...
  const defaultBandXAxis = React30.useMemo(() => [{
  ...
  const defaultBandYAxis = React30.useMemo(() => [{
  ...
  const seriesWithDefault = React30.useMemo(() => series.map((s) => _extends({
    type: "bar"
  }, s, {
    layout: hasHorizontalSeries ? "horizontal" : "vertical"
  })), [hasHorizontalSeries, series]);
  const defaultXAxis = hasHorizontalSeries ? void 0 : defaultBandXAxis;
  const processedXAxis = React30.useMemo(() => {
    if (!xAxis) {
      return defaultXAxis;
    }
  ...
  const processedYAxis = React30.useMemo(() => {
    if (!yAxis) {
      return defaultYAxis;
    }
...
function FocusedBar(props) {
  ...
  return (0, import_jsx_runtime28.jsx)("rect", _extends({
    fill: "none",
    stroke: (theme.vars ?? theme).palette.text.primary,
    strokeWidth: 2,
    x: x - 3,
...
var BarChart = React32.forwardRef(function BarChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  });
  ...
  return (0, import_jsx_runtime29.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime29.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar ? (0, import_jsx_runtime29.jsx)(Toolbar, _extends({}, props.slotProps?.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime29.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime29.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime29.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime29.jsxs)("g", _extends({}, clipPathGroupProps, {
          children: [(0, import_jsx_runtime29.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime29.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime29.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), (0, import_jsx_runtime29.jsx)(FocusedBar, {})]
        })), (0, import_jsx_runtime29.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime29.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      })), !props.loading && (0, import_jsx_runtime29.jsx)(Tooltip, _extends({}, props.slotProps?.tooltip))]
    }))
  }));
});
...
true ? BarChart.propTypes = {
   ...
   * ```
   */
  hiddenItems: import_prop_types12.default.arrayOf(import_prop_types12.default.shape({
    ...
    type: import_prop_types12.default.oneOf(["bar"]).isRequired
  })),
  /**
   ...
   * ```
   */
  initialHiddenItems: import_prop_types12.default.arrayOf(import_prop_types12.default.shape({
    dataIndex: import_prop_types12.default.number,
    seriesId: import_prop_types12.default.oneOfType([import_prop_types12.default.number, import_prop_types12.default.string]),
    type: import_prop_types12.default.oneOf(["bar"]).isRequired
  })),
   ...
   */
  onHiddenItemsChange: import_prop_types12.default.func,
  /**
   ...
   */
  onTooltipItemChange: import_prop_types12.default.func,
  /**
   * The type of renderer to use for the bar plot.
   * - `svg-single`: Renders every bar in a `<rect />` element.
   * - `svg-batch`: Batch renders bars in `<path />` elements for better performance with large datasets, at the cost of some limitations.
   ...
   * @default 'svg-single'
   */
  renderer: import_prop_types12.default.oneOf(["svg-batch", "svg-single"]),
  /**
   ...
   */
  tooltipItem: import_prop_types12.default.shape({
    dataIndex: import_prop_types12.default.number.isRequired,
    seriesId: import_prop_types12.default.oneOfType([import_prop_types12.default.number, import_prop_types12.default.string]).isRequired,
    type: import_prop_types12.default.oneOf(["bar"]).isRequired
  }),
...
var AnimatedRect2 = styled_default("rect", {
  slot: "internal",
...
function AppearingMask(props) {
  ...
  return (0, import_jsx_runtime30.jsxs)(React33.Fragment, {
    children: [(0, import_jsx_runtime30.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime30.jsx)(AnimatedRect2, {
...
var _excluded16 = ["skipAnimation", "ownerState"];
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(AppearingMask, {
    skipAnimation,
    id: `${ownerState.id}-area-clip`,
    children: (0, import_jsx_runtime31.jsx)("path", _extends({
...
var _excluded17 = ["id", "classes", "color", "gradientId", "slots", "slotProps", "onClick"];
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(Area, _extends({}, other, areaProps));
}
...
var _excluded18 = ["slots", "slotProps", "onItemClick", "skipAnimation"];
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(AreaPlotRoot, _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientId
    }) => !!area && (0, import_jsx_runtime33.jsx)(AreaElement, {
      id: seriesId,
      d,
      color,
      gradientId,
...
var _excluded19 = ["skipAnimation", "ownerState"];
var AnimatedLine = React38.forwardRef(function AnimatedLine2(props, ref) {
  const {
    skipAnimation,
    ownerState
  ...
  return (0, import_jsx_runtime34.jsx)(AppearingMask, {
    skipAnimation,
    id: `${ownerState.id}-line-clip`,
    children: (0, import_jsx_runtime34.jsx)("path", _extends({
...
true ? AnimatedLine.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  d: import_prop_types16.default.string.isRequired,
...
var _excluded20 = ["id", "classes", "color", "gradientId", "slots", "slotProps", "onClick", "hidden"];
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(Line, _extends({}, other, lineProps));
}
true ? LineElement.propTypes = {
  ...
  d: import_prop_types17.default.string.isRequired,
  ...
  const allData = React40.useMemo(() => {
    ...
    for (const stackingGroup of stackingGroups) {
      ...
      for (const seriesId of groupIds) {
        ...
        const linePath = line_default().x((d2) => d2.isExtension ? d2.x : xPosition(d2.x)).defined((d2) => connectNulls || !d2.nullData || !!d2.isExtension).y((d2) => {
          if (hidden) {
            return yScale(yScale.domain()[0]);
          }
          return yScale(d2.y[1]);
        });
...
var _excluded21 = ["slots", "slotProps", "skipAnimation", "onItemClick"];
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(LinePlotRoot, _extends({}, other, {
    children: completedData.map(({
      d,
      seriesId,
      color,
      ...
      return (0, import_jsx_runtime36.jsx)(LineElement, {
        id: seriesId,
        d,
        color,
        gradientId,
...
var _excluded27 = ["x", "y", "id", "classes", "color", "dataIndex", "onClick", "skipAnimation", "isFaded", "isHighlighted", "shape", "hidden"];
...
function CircleMarkElement(props) {
  ...
  return (0, import_jsx_runtime37.jsx)(Circle, _extends({}, other, {
    cx: x,
    cy: y,
    r: 5,
...
true ? CircleMarkElement.propTypes = {
   ...
   */
  shape: import_prop_types19.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
   */
...
var _excluded28 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "onClick", "skipAnimation", "isFaded", "isHighlighted", "hidden", "style"];
...
function MarkElement(props) {
  ...
  const classes = useUtilityClasses10(ownerState);
  return (0, import_jsx_runtime38.jsx)(MarkElementPath, _extends({}, other, {
...
true ? MarkElement.propTypes = {
   ...
   * @default false
   */
  isFaded: import_prop_types20.default.bool,
  /**
   * If `true`, the marker is highlighted.
   * @default false
   */
  isHighlighted: import_prop_types20.default.bool,
  /**
   * The shape of the marker.
   */
  shape: import_prop_types20.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired,
  /**
   * If `true`, animations are skipped.
   */
  ...
  const allData = React44.useMemo(() => {
    ...
    for (const stackingGroup of stackingGroups) {
      ...
      for (const seriesId of groupIds) {
        ...
        const colorGetter = getColor_default2(series[seriesId], xAxes[xAxisId], yAxes[yAxisId]);
        const marks = [];
        if (xData) {
...
function MarkPlot(props) {
  ...
  const highlightedItems = React45.useMemo(() => {
    const rep = {};
    for (const {
      dataIndex,
      axisId
    ...
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime39.jsx)("g", {
        ...
        children: marks.map(({
          ...
          return (0, import_jsx_runtime39.jsx)(Mark, _extends({
            id: seriesId,
            dataIndex: index,
            shape,
            color,
...
var _excluded30 = ["x", "y", "id", "classes", "color", "shape"];
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(Element, _extends({
    pointerEvents: "none",
    className: classes.root,
...
true ? LineHighlightElement.propTypes = {
  ...
  shape: import_prop_types22.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired
} : void 0;
  ...
  return (0, import_jsx_runtime41.jsx)("g", _extends({}, other, {
    children: highlightedIndexes.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        return (0, import_jsx_runtime41.jsx)(Element, _extends({
          id: seriesId,
...
var LINE_CHART_PLUGINS = [useChartZAxis, useChartBrush, useChartTooltip, useChartInteraction, useChartCartesianAxis, useChartHighlight, useChartVisibilityManager, useChartKeyboardNavigation];

// node_modules/@mui/x-charts/esm/LineChart/useLineChartProps.js
var _excluded32 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "onAreaClick", "onLineClick", "onMarkClick", "axisHighlight", "disableLineItemHighlight", "hideLegend", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "className", "showToolbar", "brushConfig"];
var useLineChartProps = (props) => {
  ...
  const id = useId();
  const clipPathId = `${id}-clip-path`;
  const seriesWithDefault = React48.useMemo(() => series.map((s) => _extends({
...
function FocusedLineMark() {
  ...
  const xAxisId = series.xAxisId ?? xAxisIds[0];
  const yAxisId = series.yAxisId ?? yAxisIds[0];
  return (0, import_jsx_runtime42.jsx)("rect", {
    fill: "none",
    stroke: (theme.vars ?? theme).palette.text.primary,
    strokeWidth: 2,
...
var LineChart = React49.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
  });
  ...
  const Tooltip = props.slots?.tooltip ?? ChartsTooltip;
  const Toolbar = props.slots?.toolbar;
  return (0, import_jsx_runtime43.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime43.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar ? (0, import_jsx_runtime43.jsx)(Toolbar, _extends({}, props.slotProps?.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime43.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime43.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime43.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime43.jsxs)("g", _extends({}, clipPathGroupProps, {
          children: [(0, import_jsx_runtime43.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime43.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime43.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime43.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
        })), (0, import_jsx_runtime43.jsx)(FocusedLineMark, {}), (0, import_jsx_runtime43.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime43.jsx)("g", {
          "data-drawing-container": true,
          children: (0, import_jsx_runtime43.jsx)(MarkPlot, _extends({}, markPlotProps))
        }), (0, import_jsx_runtime43.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime43.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      })), !props.loading && (0, import_jsx_runtime43.jsx)(Tooltip, _extends({}, props.slotProps?.tooltip))]
    }))
  }));
});
...
true ? LineChart.propTypes = {
   ...
   * Configuration for the brush interaction.
   */
  brushConfig: import_prop_types24.default.shape({
    enabled: import_prop_types24.default.bool,
    preventHighlight: import_prop_types24.default.bool,
    preventTooltip: import_prop_types24.default.bool
  }),
  ...
  enableKeyboardNavigation: import_prop_types24.default.bool,
  /**
   * Options to enable features planned for the next major.
   */
  experimentalFeatures: import_prop_types24.default.shape({
    preferStrictDomainInLineCharts: import_prop_types24.default.bool
  }),
  /**
   * Option to display a cartesian grid in the background.
   */
   ...
   * ```
   */
  hiddenItems: import_prop_types24.default.arrayOf(import_prop_types24.default.shape({
    ...
    type: import_prop_types24.default.oneOf(["line"]).isRequired
  })),
  /**
   * If `true`, the legend is not rendered.
   */
   ...
   * Identified by the axis id, and data index.
   */
  highlightedAxis: import_prop_types24.default.arrayOf(import_prop_types24.default.shape({
    axisId: import_prop_types24.default.oneOfType([import_prop_types24.default.number, import_prop_types24.default.string]).isRequired,
   ...
   * ```
   */
  initialHiddenItems: import_prop_types24.default.arrayOf(import_prop_types24.default.shape({
    dataIndex: import_prop_types24.default.number,
    seriesId: import_prop_types24.default.oneOfType([import_prop_types24.default.number, import_prop_types24.default.string]),
    type: import_prop_types24.default.oneOf(["line"]).isRequired
  })),
   ...
   */
  onAreaClick: import_prop_types24.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   ...
   * @param {AxisItemIdentifier[]} axisItems The array of axes item identifiers.
   */
  onHighlightedAxisChange: import_prop_types24.default.func,
  /**
   * Callback fired when a line element is clicked.
   */
  onLineClick: import_prop_types24.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types24.default.func,
  /**
   * The callback fired when the tooltip item changes.
   *
   * @param {SeriesItemIdentifier<TSeries> | null} tooltipItem  The newly highlighted item.
   ...
   * Used when the tooltip is controlled.
   */
  tooltipItem: import_prop_types24.default.shape({
    dataIndex: import_prop_types24.default.number,
    seriesId: import_prop_types24.default.oneOfType([import_prop_types24.default.number, import_prop_types24.default.string]).isRequired,
    type: import_prop_types24.default.oneOf(["line"]).isRequired
  }),
  ...
  xAxis: import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.shape({
    ...
    groups: import_prop_types24.default.arrayOf(import_prop_types24.default.shape({
    ...
    ordinalTimeTicks: import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.oneOf(["biweekly", "days", "hours", "months", "quarterly", "weeks", "years"]), import_prop_types24.default.shape({
      format: import_prop_types24.default.func.isRequired,
      getTickNumber: import_prop_types24.default.func.isRequired,
      isTick: import_prop_types24.default.func.isRequired
    })]).isRequired),
    ...
    tickSize: import_prop_types24.default.number,
    tickSpacing: import_prop_types24.default.number,
    ...
    constant: import_prop_types24.default.number,
    data: import_prop_types24.default.array,
    dataKey: import_prop_types24.default.string,
    disableLine: import_prop_types24.default.bool,
    disableTicks: import_prop_types24.default.bool,
    ...
    position: import_prop_types24.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types24.default.bool,
    scaleType: import_prop_types24.default.oneOf(["symlog"]),
    slotProps: import_prop_types24.default.object,
    slots: import_prop_types24.default.object,
    sx: import_prop_types24.default.oneOfType([import_prop_types24.default.arrayOf(import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.object, import_prop_types24.default.bool])), import_prop_types24.default.func, import_prop_types24.default.object]),
    tickInterval: import_prop_types24.default.oneOfType([import_prop_types24.default.oneOf(["auto"]), import_prop_types24.default.array, import_prop_types24.default.func]),
    ...
    label: import_prop_types24.default.string,
    labelStyle: import_prop_types24.default.object,
    max: import_prop_types24.default.oneOfType([import_prop_types24.default.number, import_prop_types24.default.shape({
      valueOf: import_prop_types24.default.func.isRequired
    })]),
    min: import_prop_types24.default.oneOfType([import_prop_types24.default.number, import_prop_types24.default.shape({
      valueOf: import_prop_types24.default.func.isRequired
    })]),
    offset: import_prop_types24.default.number,
    position: import_prop_types24.default.oneOf(["bottom", "none", "top"]),
...
var _excluded33 = ["xAxis", "yAxis", "width", "height", "margin", "color", "baseline", "sx", "showTooltip", "showHighlight", "axisHighlight", "children", "slots", "slotProps", "data", "plotType", "valueFormatter", "area", "curve", "className", "disableClipping", "clipAreaOffset", "onHighlightChange", "onHighlightedAxisChange", "highlightedAxis", "highlightedItem"];
var SPARK_LINE_DEFAULT_MARGIN = 5;
var SparkLineChart = React50.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis: xAxisProps,
    yAxis: yAxisProps,
    width,
  ...
  const id = useId();
  const clipPathId = `${id}-clip-path`;
  const clipPathOffset = React50.useMemo(() => ({
  ...
  const defaultXHighlight = React50.useMemo(() => showHighlight && plotType === "bar" ? {
    x: "band"
  } : {
    x: "none"
  }, [plotType, showHighlight]);
  const axisHighlight = React50.useMemo(() => _extends({}, defaultXHighlight, inAxisHighlight), [defaultXHighlight, inAxisHighlight]);
  const Tooltip = props.slots?.tooltip ?? ChartsTooltip;
  const colors = React50.useMemo(() => {
    if (color == null) {
      return void 0;
    }
    return typeof color === "function" ? (mode) => [color(mode)] : [color];
  }, [color]);
  const series = React50.useMemo(() => [_extends({
    type: plotType,
    data,
    valueFormatter
  }, plotType === "bar" ? {} : {
  ...
  const xAxis = React50.useMemo(() => [_extends({
    id: DEFAULT_X_AXIS_KEY,
  ...
  const yAxis = React50.useMemo(() => [_extends({
    id: DEFAULT_Y_AXIS_KEY
  }, yAxisProps, {
    position: "none"
  })], [yAxisProps]);
  return (0, import_jsx_runtime44.jsxs)(ChartDataProvider, {
    series,
    width,
    height,
    margin,
    ...
    highlightedAxis,
    highlightedItem,
    children: [(0, import_jsx_runtime44.jsxs)(ChartsSurface, _extends({
      className,
      ref,
      sx
    }, other, {
      children: [(0, import_jsx_runtime44.jsxs)("g", {
        clipPath: `url(#${clipPathId})`,
        children: [plotType === "bar" && (0, import_jsx_runtime44.jsx)(BarPlot, {
          skipAnimation: true,
          slots,
          slotProps
        }), plotType === "line" && (0, import_jsx_runtime44.jsxs)(React50.Fragment, {
          children: [(0, import_jsx_runtime44.jsx)(AreaPlot, {
            skipAnimation: true,
            slots,
            slotProps
          }), (0, import_jsx_runtime44.jsx)(LinePlot, {
            skipAnimation: true,
            slots,
            slotProps
          })]
        ...
        children: [(0, import_jsx_runtime44.jsx)(LineHighlightPlot, {
          slots,
          slotProps
        }), (0, import_jsx_runtime44.jsx)(FocusedLineMark, {})]
      }), disableClipping ? null : (0, import_jsx_runtime44.jsx)(ChartsClipPath, {
        id: clipPathId,
        offset: clipPathOffset
      }), (0, import_jsx_runtime44.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), children]
    })), showTooltip && (0, import_jsx_runtime44.jsx)(Tooltip, _extends({}, props.slotProps?.tooltip))]
  });
});
...
true ? SparkLineChart.propTypes = {
   ...
   * @default 0
   */
  baseline: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["max", "min"]), import_prop_types25.default.number]),
  /**
   * Configuration for the brush interaction.
   */
  brushConfig: import_prop_types25.default.shape({
    enabled: import_prop_types25.default.bool,
    preventHighlight: import_prop_types25.default.bool,
    preventTooltip: import_prop_types25.default.bool
  }),
   ...
   */
  clipAreaOffset: import_prop_types25.default.shape({
   ...
   */
  color: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.string]),
  /**
   * @default 'linear'
   */
  curve: import_prop_types25.default.oneOf(["bumpX", "bumpY", "catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
   ...
   * @default false
   */
  disableClipping: import_prop_types25.default.bool,
  /**
   * If true, the voronoi interaction are ignored.
   */
  disableVoronoi: import_prop_types25.default.bool,
  enableKeyboardNavigation: import_prop_types25.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * ```
   */
  hiddenItems: import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.shape({
    ...
    type: import_prop_types25.default.oneOf(["bar"]).isRequired
  }), import_prop_types25.default.shape({
    dataIndex: import_prop_types25.default.number,
    seriesId: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.string]),
    type: import_prop_types25.default.oneOf(["line"]).isRequired
  }), import_prop_types25.default.shape({
    dataIndex: import_prop_types25.default.number,
    seriesId: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.string]),
    type: import_prop_types25.default.oneOf(["scatter"]).isRequired
  }), import_prop_types25.default.shape({
    dataIndex: import_prop_types25.default.number,
    seriesId: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.string]),
    type: import_prop_types25.default.oneOf(["pie"]).isRequired
  }), import_prop_types25.default.shape({
    dataIndex: import_prop_types25.default.number,
    seriesId: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.string]),
    type: import_prop_types25.default.oneOf(["radar"]).isRequired
  })]).isRequired),
  /**
   * The controlled axis highlight.
   * Identified by the axis id, and data index.
   */
  highlightedAxis: import_prop_types25.default.arrayOf(import_prop_types25.default.shape({
    axisId: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.string]).isRequired,
   ...
   * ```
   */
  initialHiddenItems: import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.shape({
    dataIndex: import_prop_types25.default.number,
    seriesId: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.string]),
    type: import_prop_types25.default.oneOf(["bar"]).isRequired
  }), import_prop_types25.default.shape({
   ...
   * @param {VisibilityIdentifier[]} hiddenItems The new list of hidden identifiers.
   */
  onHiddenItemsChange: import_prop_types25.default.func,
  /**
   * The callback fired when the highlighted item changes.
   *
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   ...
   * @param {AxisItemIdentifier[]} axisItems The array of axes item identifiers.
   */
  onHighlightedAxisChange: import_prop_types25.default.func,
  /**
   ...
   * @param {SeriesItemIdentifier<TSeries> | null} tooltipItem  The newly highlighted item.
   */
  onTooltipItemChange: import_prop_types25.default.func,
  /**
   * Type of plot used.
   * @default 'line'
   */
   ...
   * Used when the tooltip is controlled.
   */
  tooltipItem: import_prop_types25.default.oneOfType([import_prop_types25.default.shape({
    dataIndex: import_prop_types25.default.number.isRequired,
    seriesId: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.string]).isRequired,
    type: import_prop_types25.default.oneOf(["bar"]).isRequired
  }), import_prop_types25.default.shape({
   ...
   */
  voronoiMaxRadius: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["item"]), import_prop_types25.default.number]),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
   ...
   */
  xAxis: import_prop_types25.default.oneOfType([import_prop_types25.default.shape({
    axis: import_prop_types25.default.oneOf(["x"]),
    barGapRatio: import_prop_types25.default.number,
    categoryGapRatio: import_prop_types25.default.number,
    ...
    groups: import_prop_types25.default.arrayOf(import_prop_types25.default.shape({
    ...
    ignoreTooltip: import_prop_types25.default.bool,
    label: import_prop_types25.default.string,
    labelStyle: import_prop_types25.default.object,
    offset: import_prop_types25.default.number,
    ordinalTimeTicks: import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["biweekly", "days", "hours", "months", "quarterly", "weeks", "years"]), import_prop_types25.default.shape({
      format: import_prop_types25.default.func.isRequired,
      getTickNumber: import_prop_types25.default.func.isRequired,
      isTick: import_prop_types25.default.func.isRequired
    })]).isRequired),
    position: import_prop_types25.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types25.default.bool,
    scaleType: import_prop_types25.default.oneOf(["band"]),
    slotProps: import_prop_types25.default.object,
    slots: import_prop_types25.default.object,
    sx: import_prop_types25.default.oneOfType([import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object, import_prop_types25.default.bool])), import_prop_types25.default.func, import_prop_types25.default.object]),
    ...
    tickLabelMinGap: import_prop_types25.default.number,
    ...
    tickSize: import_prop_types25.default.number,
    tickSpacing: import_prop_types25.default.number,
    valueFormatter: import_prop_types25.default.func
  }), import_prop_types25.default.shape({
    axis: import_prop_types25.default.oneOf(["x"]),
    classes: import_prop_types25.default.object,
    ...
    position: import_prop_types25.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types25.default.bool,
    scaleType: import_prop_types25.default.oneOf(["point"]),
    slotProps: import_prop_types25.default.object,
    slots: import_prop_types25.default.object,
    sx: import_prop_types25.default.oneOfType([import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object, import_prop_types25.default.bool])), import_prop_types25.default.func, import_prop_types25.default.object]),
    tickInterval: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["auto"]), import_prop_types25.default.array, import_prop_types25.default.func]),
    ...
    position: import_prop_types25.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types25.default.bool,
    scaleType: import_prop_types25.default.oneOf(["log"]),
    slotProps: import_prop_types25.default.object,
    slots: import_prop_types25.default.object,
    sx: import_prop_types25.default.oneOfType([import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object, import_prop_types25.default.bool])), import_prop_types25.default.func, import_prop_types25.default.object]),
    tickInterval: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["auto"]), import_prop_types25.default.array, import_prop_types25.default.func]),
    ...
    constant: import_prop_types25.default.number,
    data: import_prop_types25.default.array,
    dataKey: import_prop_types25.default.string,
    disableLine: import_prop_types25.default.bool,
    disableTicks: import_prop_types25.default.bool,
    ...
    position: import_prop_types25.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types25.default.bool,
    scaleType: import_prop_types25.default.oneOf(["symlog"]),
    slotProps: import_prop_types25.default.object,
    slots: import_prop_types25.default.object,
    sx: import_prop_types25.default.oneOfType([import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object, import_prop_types25.default.bool])), import_prop_types25.default.func, import_prop_types25.default.object]),
    tickInterval: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["auto"]), import_prop_types25.default.array, import_prop_types25.default.func]),
    ...
    position: import_prop_types25.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types25.default.bool,
    scaleType: import_prop_types25.default.oneOf(["pow"]),
    slotProps: import_prop_types25.default.object,
    slots: import_prop_types25.default.object,
    sx: import_prop_types25.default.oneOfType([import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object, import_prop_types25.default.bool])), import_prop_types25.default.func, import_prop_types25.default.object]),
    tickInterval: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["auto"]), import_prop_types25.default.array, import_prop_types25.default.func]),
    ...
    position: import_prop_types25.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types25.default.bool,
    scaleType: import_prop_types25.default.oneOf(["sqrt"]),
    slotProps: import_prop_types25.default.object,
    slots: import_prop_types25.default.object,
    sx: import_prop_types25.default.oneOfType([import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object, import_prop_types25.default.bool])), import_prop_types25.default.func, import_prop_types25.default.object]),
    tickInterval: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["auto"]), import_prop_types25.default.array, import_prop_types25.default.func]),
    ...
    label: import_prop_types25.default.string,
    labelStyle: import_prop_types25.default.object,
    max: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.shape({
      valueOf: import_prop_types25.default.func.isRequired
    })]),
    min: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.shape({
      valueOf: import_prop_types25.default.func.isRequired
    })]),
    offset: import_prop_types25.default.number,
    position: import_prop_types25.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types25.default.bool,
    scaleType: import_prop_types25.default.oneOf(["time"]),
    slotProps: import_prop_types25.default.object,
    slots: import_prop_types25.default.object,
    sx: import_prop_types25.default.oneOfType([import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object, import_prop_types25.default.bool])), import_prop_types25.default.func, import_prop_types25.default.object]),
    tickInterval: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["auto"]), import_prop_types25.default.array, import_prop_types25.default.func]),
    ...
    position: import_prop_types25.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types25.default.bool,
    scaleType: import_prop_types25.default.oneOf(["utc"]),
    slotProps: import_prop_types25.default.object,
    slots: import_prop_types25.default.object,
    sx: import_prop_types25.default.oneOfType([import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object, import_prop_types25.default.bool])), import_prop_types25.default.func, import_prop_types25.default.object]),
    tickInterval: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["auto"]), import_prop_types25.default.array, import_prop_types25.default.func]),
    ...
    position: import_prop_types25.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types25.default.bool,
    scaleType: import_prop_types25.default.oneOf(["linear"]),
    slotProps: import_prop_types25.default.object,
    slots: import_prop_types25.default.object,
    sx: import_prop_types25.default.oneOfType([import_prop_types25.default.arrayOf(import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object, import_prop_types25.default.bool])), import_prop_types25.default.func, import_prop_types25.default.object]),
    tickInterval: import_prop_types25.default.oneOfType([import_prop_types25.default.oneOf(["auto"]), import_prop_types25.default.array, import_prop_types25.default.func]),
   ...
   * Notice it is a single [[AxisConfig]] object, not an array of configuration.
   */
  yAxis: import_prop_types25.default.oneOfType([import_prop_types25.default.shape({
    axis: import_prop_types25.default.oneOf(["y"]),
    barGapRatio: import_prop_types25.default.number,
    categoryGapRatio: import_prop_types25.default.number,
    classes: import_prop_types25.default.object,
    colorMap: import_prop_types25.default.oneOfType([import_prop_types25.default.shape({
    ...
    position: import_prop_types25.default.oneOf(["left", "none", "right"]),
    reverse: import_prop_types25.default.bool,
    scaleType: import_prop_types25.default.oneOf(["band"]),
    slotProps: import_prop_types25.default.object,
    slots: import_prop_types25.default.object,
...
//# sourceMappingURL=@mui_x-charts_SparkLineChart.js.map
