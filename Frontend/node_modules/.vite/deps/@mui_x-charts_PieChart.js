...
// node_modules/@mui/x-charts/esm/PieChart/dataTransform/getModifiedArcProperties.js
...
var _excluded3 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "skipAnimation", "hidden"];
...
// node_modules/@mui/x-charts/esm/PieChart/FocusedPieArc.js
var React6 = __toESM(require_react(), 1);
var import_jsx_runtime6 = __toESM(require_jsx_runtime(), 1);
var _excluded5 = ["arcLabelRadius"];
function FocusedPieArc(props) {
  ...
  const _getModifiedArcProper = getModifiedArcProperties(series, pieSeriesLayout[focusedItem.seriesId], isHighlighted, isFaded), arcSizes = _objectWithoutPropertiesLoose(_getModifiedArcProper, _excluded5);
  return (0, import_jsx_runtime6.jsx)(PieArc, _extends({
...
var _excluded6 = ["series", "width", "height", "margin", "colors", "sx", "skipAnimation", "hideLegend", "children", "slots", "slotProps", "onItemClick", "loading", "highlightedItem", "onHighlightChange", "className", "showToolbar"];
var PieChart = React7.forwardRef(function PieChart2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime7.jsxs)(ChartsWrapper, {
      legendPosition: slotProps?.legend?.position,
      legendDirection: slotProps?.legend?.direction ?? "vertical",
      sx,
      hideLegend: hideLegend ?? false,
      children: [showToolbar && Toolbar ? (0, import_jsx_runtime7.jsx)(Toolbar, _extends({}, slotProps?.toolbar)) : null, !hideLegend && (0, import_jsx_runtime7.jsx)(ChartsLegend, {
        direction: slotProps?.legend?.direction ?? "vertical",
        slots,
        slotProps
      }), (0, import_jsx_runtime7.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime7.jsx)(PiePlot, {
          slots,
          slotProps,
          onItemClick
        }), (0, import_jsx_runtime7.jsx)(FocusedPieArc, {}), (0, import_jsx_runtime7.jsx)(ChartsOverlay, {
          loading,
          slots,
          slotProps
        }), children]
      })), !loading && (0, import_jsx_runtime7.jsx)(Tooltip, _extends({
        trigger: "item"
      }, slotProps?.tooltip))]
    })
  }));
...
true ? PieChart.propTypes = {
   ...
   * ```
   */
  hiddenItems: import_prop_types6.default.arrayOf(import_prop_types6.default.shape({
    ...
    type: import_prop_types6.default.oneOf(["pie"]).isRequired
  })),
  /**
   ...
   * ```
   */
  initialHiddenItems: import_prop_types6.default.arrayOf(import_prop_types6.default.shape({
    dataIndex: import_prop_types6.default.number,
    seriesId: import_prop_types6.default.oneOfType([import_prop_types6.default.number, import_prop_types6.default.string]),
    type: import_prop_types6.default.oneOf(["pie"]).isRequired
  })),
   ...
   */
  onHiddenItemsChange: import_prop_types6.default.func,
  /**
   ...
   */
  onTooltipItemChange: import_prop_types6.default.func,
  /**
   ...
   */
  tooltipItem: import_prop_types6.default.shape({
